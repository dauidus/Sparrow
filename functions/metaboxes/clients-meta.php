...
function settings_clients_metabox() {
    ...
    <table class="form-table meta-box">
		<tr>
			<th><label for="client-url"><?php _e( "Client URL:", 'pwvintage' ); ?></label></th>
			<td>
...
function add_clients_meta_boxes() {
	add_meta_box( 'client-url-settings-metabox', __( "Clients Settings", 'pwvintage' ), 'settings_clients_metabox', 'clients', 'normal', 'high' );
}
