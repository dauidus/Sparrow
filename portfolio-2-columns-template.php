...
<div id="blog-wrapper" class="wrapper-960">
    ...
    <div id="portfolio-wrap">
        ...
        <div id="portfolio-two-column" class="clearfix">
            <ul id="portfolio-list">
                ...
                ?>
                <li class="view view-first view-two <?php if($terms) {  foreach ($terms as $term) { echo $term->slug . ' '; } } ?>">
                        ...
                        <?php if ( has_post_thumbnail()) : ?>
                            ...
                            <a href="<?php echo $thumbnail; ?>" class="post-image" title="<?php the_title(); ?>" rel="prettyPhoto"> 
                                <img src="<?php echo get_bloginfo('template_directory');?>/includes/timthumb.php?src=<?php echo $thumbnail_src; ?>&amp;h=250&amp;w=420&amp;zc=1&amp;q=100" alt="<?php the_title(); ?>" alt=""/>
                            </a>
                        <?php endif; ?>
                    ...
                    <div class="mask">
                        ...
                        <p class="portfolio-content"><?php the_news_excerpt('25','','','plain','no'); ?></p> 
                        <?php } ?>
