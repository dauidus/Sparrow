...
<?php get_header(' '); ?>
	<div id="banner">
    	<div class="wrapper-960">
			...
			<?php } elseif( is_tag() ) { ?>
            <h2 id="archive-title"><?php _e('Posts Tagged: ','pwvintage') ?>&quot;<?php single_tag_title(); ?>&quot;</h1>
            <?php  } elseif (is_day()) { ?>
            <h2 id="archive-title"><?php _e('Archive For: ','pwvintage') ?><?php the_time('F jS, Y'); ?></h1>
            <?php  } elseif (is_month()) { ?>
            <h2 id="archive-title"><?php _e('Archive For: ','pwvintage') ?><?php the_time('F, Y'); ?></h1>
            <?php  } elseif (is_year()) { ?>
            <h2 id="archive-title"><?php _e('Archive For: ','pwvintage') ?><?php the_time('Y'); ?></h1>
            <?php  } elseif (isset($_GET['paged']) && !empty($_GET['paged'])) { ?>
            <h2 id="archive-title"><?php _e('Blog Archives','pwvintage') ?></h1>
            <?php } ?>
