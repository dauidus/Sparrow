	...
	function widget($args, $instance) { 
        ...
        <div class="location-map">
        	...
        	<?php
							...
							?>
							<div id="featured_overview" style="height:200px; width:450px"></div>
							<?php		
        	...
        	<a class="button inactive" href="<?php echo get_permalink($pageid); ?>" title="Directions">Get Directions to The Nest</a>
