...
class Woo_Widget_Blog extends WP_Widget {
		...
		if ( have_posts() ) { $count = 0;
			while ( have_posts() ) { the_post(); $count++; ?>
            	...
            	<div style="margin-bottom:20px; margin-left:10px;">
                    ...
                    <div style="float:left; margin: 0 15px 7px 10px; width:180px; padding:5px; background: #EAEAEA; -moz-box-shadow: 0px 0px 3px #333333; -webkit-box-shadow: 0px 0px 3px #333333; box-shadow: 0px 0px 3px #333333; border:1px solid #e0e0dc; border-radius:8px; text-align:center; max-height:120px;">
                        <div style="background:#ffffff; -moz-box-shadow: 0px 0px 3px #333333; -webkit-box-shadow: 0px 0px 3px #333333;
    box-shadow: 0px 0px 3px #333333;">
                    ...
                    <div style="margin: 0px 0 0 215px;">
                        <h2 style="padding:30px 0px 10px 0;"><a href="<?php the_permalink(); ?>" rel="bookmark" title="<?php the_title_attribute(); ?>"><?php the_title(); ?></a></h2>
                    </div>	
